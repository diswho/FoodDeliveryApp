            ...
            return (
              <TextButton
                ...
                buttonContainerStyle={{
                  ...
                  backgroundColor:
                    item.id == deliveryTime ? COLORS.primary : COLORS.lightGray,
                }}
            ...
            return (
              <TextIconButton
                ...
                containerStyle={{
                  ...
                  borderRadius: SIZES.base,
                  backgroundColor:
                    item.id == rating ? COLORS.primary : COLORS.lightGray,
                }}
                label={item.label}
                labelStyle={{
            ...
            return (
              <TextButton
                ...
                buttonContainerStyle={{
                  ...
                  borderRadius: SIZES.base,
                  backgroundColor:
                    item.id == tags ? COLORS.primary : COLORS.lightGray,
                }}
